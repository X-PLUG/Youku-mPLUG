...
def _none_level_to_args(level, _hparams):
    return ()
...
LEVEL_TO_ARG = {
    ...
    "HorizontalFlip": _none_level_to_args,
}
...
def rand_augment_ops(magnitude=10, hparams=None, transforms=None):
    ...
    transforms = transforms or _RAND_TRANSFORMS
    return [
        AugmentOp(name, prob=1, magnitude=magnitude, hparams=hparams)
